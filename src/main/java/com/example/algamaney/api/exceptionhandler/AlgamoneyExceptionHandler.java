...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> retornaResultadoDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
	...
	@ResponseStatus(code=HttpStatus.NOT_FOUND)
	public ResponseEntity<Object> retornaEmptyResultDataAccessException(EmptyResultDataAccessException ex,WebRequest request) {
